...
export const WalletConnect = styled.button`
    background-color:${color.dinoprimary};
    // color:#404040;
    color:${color.black};
    padding:0px 24px;
    height:43px;
    ...
    &:hover{
        background-color:${Hex2Rgba(color.dinohoverbtn, .8)};
        transform: scale(1.1);
        color:${color.white};
    }
    outline:none;
...
export const Launch = styled.div<{showMintedNfts?:string}>`
    margin-top:16px;
    min-height:769px;
    background: linear-gradient(180deg, #45474B 0%, #0A141B 100%);
...
export const LaunchBg = styled.div`
    ...
    pointer-events:none;
` 
export const LaunchBg2 = styled.div`
...
export const Phase = styled.div<{active:string,switch?:string}>`
    background-color:${props => props.active === 'true' ? color.secondaryLight : color.dinosecondary};
